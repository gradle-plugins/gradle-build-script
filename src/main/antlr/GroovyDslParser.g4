...
parser grammar GroovyDslParser;

@header {
package dev.gradleplugins.buildscript;
}

options { tokenVocab = GroovyDslLexer; }
...
infixOperation
    : elvisExpression (/* NO NL! */ infixOperationSuffix)*
    ;

infixOperationSuffix
    : inOperationSuffix
    | instanceOfOperationSuffix
    ;
...
literalLineStringLiteral
    : SINGLE_QUOTE_OPEN (literalStringContent)* SINGLE_QUOTE_CLOSE
    ;
