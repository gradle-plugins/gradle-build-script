...
SINGLE_QUOTE_OPEN : '\'' -> pushMode(LiteralLineString) ;
...
Inside_SINGLE_QUOTE_OPEN: SINGLE_QUOTE_OPEN -> pushMode(LiteralLineString), type(SINGLE_QUOTE_OPEN) ;
