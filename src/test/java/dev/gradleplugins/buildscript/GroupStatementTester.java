...
//        assertEquals(expectedBlockWithSingleGroup__call_someMethod_no_args(), GradleBlockStatement.BodyDeclaration.newBuilder().add(new GroupStatement(Collections.singletonList(call("someMethod").toStatement()))).build().toString(syntax()));
//    }
...
//        assertEquals(expectedBlockWithSingleGroup__call_someMethod_no_args__call_someOtherMethod_foo_string(), GradleBlockStatement.BodyDeclaration.newBuilder().add(new GroupStatement(Collections.singletonList(call("someMethod").toStatement()))).add(new GroupStatement(Collections.singletonList(call("someOtherMethod", string("foo")).toStatement()))).build().toString(syntax()));
//    }
