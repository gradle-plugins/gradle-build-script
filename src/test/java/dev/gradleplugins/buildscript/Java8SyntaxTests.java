...
import dev.gradleplugins.buildscript.syntax.Java8Compatibility;
import dev.gradleplugins.buildscript.syntax.JavaRender;
import dev.gradleplugins.buildscript.syntax.Syntax;
import org.junit.jupiter.api.Assumptions;

class Java8SyntaxTests extends SyntaxTester {
    @Override
    public Syntax syntax() {
        return node -> new JavaRender().render(new Java8Compatibility().transform(node)).toString();
    }
